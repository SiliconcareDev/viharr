...
<div class="g-location">
    ...
    <?php if($translation->address): ?>
    <div class="address"> <!-- Use margin-top for space -->
        <i class="icofont-location-arrow"></i>
        <span><?php echo e($translation->address); ?></span>
    </div>
    <?php endif; ?>
    <div class="location-map mt-3"> <!-- Optional spacing for the map -->
        <div id="map_content"></div>
    </div>
</div>
<?php endif; ?>
<div class="bravo-hr"></div>
<?php /**PATH /home/u603013329/domains/viharr.com/public_html/themes/BC/Hotel/Views/frontend/layouts/details/hotel-detail.blade.php ENDPATH**/ ?>