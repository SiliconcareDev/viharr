...
<div class="form-group">
	...
	<div class="form-content">
		...
		<div class="smart-search">
			<input type="text" class="smart-search-location parent_text form-control font-size-14" placeholder="<?php echo e(__("City or Airport")); ?>" value="<?php echo e($location_name); ?>" data-onLoad="<?php echo e(__("Loading...")); ?>" data-default="<?php echo e(json_encode($list_json)); ?>" id="smart-search-input">
			...
			document.addEventListener('DOMContentLoaded', function() {
				...
				new SmartSearch(input, {
					...
					onSelect: function(selectedItem) {
						...
						document.querySelector('input[name="<?php echo e($inputName); ?>"]').value = selectedItem.id;
					}
				});
			});
		</script>
	</div>
</div><?php /**PATH /home/u603013329/domains/viharr.com/public_html/themes/BC/Flight/Views/frontend/layouts/search/fields/location.blade.php ENDPATH**/ ?>