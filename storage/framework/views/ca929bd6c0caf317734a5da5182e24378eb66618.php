...
<div class="item-loop <?php echo e($wrap_class ?? ''); ?>">
    ...
    <div class="info">
        <div class="g-price">
            ...
            <?php
                // Remove any non-numeric characters from display_price and then convert to integer
                $cleanedPrice = preg_replace('/[^0-9]/', '', $row->display_price);
                $displayPrice = isset($cleanedPrice) ? intval($cleanedPrice) + 1000 : null;
            ?>
            <?php if($displayPrice !== null): ?>
                <span class="onsale">₹<?php echo e($displayPrice); ?></span>
                
            <?php else: ?>
                <span class="onsale">Price not available</span>
            <?php endif; ?>
...
<?php /**PATH /home/u603013329/domains/clubsilicon.in/public_html/themes/BC/Hotel/Views/frontend/layouts/search/loop-grid.blade.php ENDPATH**/ ?>