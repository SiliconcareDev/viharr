                ...
                <div class="g-filter-item">
                    ...
                    <div class="item-content">
                        ...
                        <?php if(count($item->terms) > 3 and empty($selected)): ?>
                            <button type="button" class="btn btn-link btn-more-item"><?php echo e(__("More")); ?> <i class="fa fa-boatet-down"></i></button>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endif; ?>
...
<?php /**PATH /home/u603013329/domains/clubsilicon.in/public_html/themes/BC/Boat/Views/frontend/layouts/search/filter-search.blade.php ENDPATH**/ ?>