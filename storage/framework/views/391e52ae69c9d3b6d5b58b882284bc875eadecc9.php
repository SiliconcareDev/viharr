            ...
            <div class="header-left">
                <a href="<?php echo e(url(app_get_locale(false,'/'))); ?>" class="bravo-logo">
                    ...
                    <?php if($logo_id): ?>
                        ...
                        <img src="<?php echo e(asset('uploads/demo/general/viharr_logo.svg')); ?>" alt="<?php echo e(setting_item('site_title')); ?>" width="300" height="90">
                    <?php endif; ?>
                ...
                <div class="bravo-menu">
                 ...
                 <script>
                    $(document).ready(function() {
                        $('.bravo-menu li:contains("Tours")').hide();
                        $('.bravo-menu li:contains("Homestays & Villas")').hide();
                        $('.bravo-menu li:contains("Car")').hide();
                    });
                </script>
            </div>
            ...
            <ul>
             ...
             <!-- List Your Property Button -->
                    <li class="list-property-item">
                        <a href="/public/page/become-a-vendor" class="list-property"><?php echo e(__('List Your Property')); ?></a>
                    </li>
            <ul class="multi-lang">
                <?php echo $__env->make('Core::frontend.currency-switcher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </ul>
...
<?php /**PATH /home/u603013329/domains/viharr.com/public_html/modules/Layout/parts/header.blade.php ENDPATH**/ ?>