            ...
            <div class="header-left">
                <a href="{{url(app_get_locale(false,'/'))}}" class="bravo-logo">
                    ...
                    @if($logo_id)
                        ...
                        <img src="{{ asset('uploads/demo/general/viharr_logo.svg') }}" alt="{{ setting_item('site_title') }}" width="300" height="90">
                    @endif
            ...
            <ul>
             ...
             <!-- List Your Property Button -->
                    <li class="list-property-item">
                        <a href="/public/page/become-a-vendor" class="list-property">{{__('List Your Property')}}</a>
                    </li>
            <ul class="multi-lang">
                @include('Core::frontend.currency-switcher')
            </ul>
