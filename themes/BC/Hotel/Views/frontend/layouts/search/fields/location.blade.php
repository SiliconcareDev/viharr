...
<div class="form-group">
    ...
    <div class="form-content">
        <label style="text-align: left; display: block;"> {{ $field['title'] }} </label>
        ...
        <div class="smart-search">
            ...
            <input type="hidden" class="child_id" name="location_id" id="location-id-field" value="{{ Request::query('location_id') }}">
